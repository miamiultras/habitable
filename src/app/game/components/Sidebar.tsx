            ...
            <div className="p-4 border-b border-purple-500/20">
                <div className="space-y-4">
                    <div className="flex items-center gap-3 font-pixel text-xs">
                        <Image src="/images/crystal.webp" alt="Crystal" width={32} height={32} />
                        <div>
                    ...
                    <div className="flex items-center gap-3 font-pixel text-xs">
                        <Image src="/images/metal.webp" alt="Metal" width={32} height={32} />
                        <div>
                    ...
                    <div className="flex items-center gap-3 font-pixel text-xs">
                        <Image src="/images/energy.webp" alt="Energy" width={32} height={32} />
                        <div>
